                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                return `
                                <a href="${data.form}"><span class="badge badge-primary">GForm</span></a>
                                `
                            },
                            orderable: false,
                            searchable: false,
